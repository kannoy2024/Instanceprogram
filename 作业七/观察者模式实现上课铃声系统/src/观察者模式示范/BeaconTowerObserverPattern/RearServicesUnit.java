...
public class RearServicesUnit implements Observer {
    private String name;
    ...
    public RearServicesUnit(String name) {
		super();
		this.name = name;//流动部队，可以全国到处增援，但是肯定会有部队编号
	}
	public RearServicesUnit(String name, Observable sub) {
        super();
    ...
    public void update() {//收到信号，会做出与信号相异的动作
        System.out.printf("%s 收到 %s，现在开始朝前线运送物质！\n ",name , sub.getState());
    }
}
